...
//    }
    ...
    {
        String url = "https://htmlparser.sourceforge.net/test/This is a Test Page.html";
        parser = new Parser (url);
        assertEquals("Expected","https://htmlparser.sourceforge.net/test/This%20is%20a%20Test%20Page.html", parser.getURL ());
    }
}
