...
public abstract class HTMLTagScanner
{
  ...
  public static String extractXMLData(HTMLNode node, String tagName, HTMLReader reader) throws HTMLParserException{
	try {	  
	    ...
	    try{
	      do {
	        ...
	        if (node!=null) {
	          ...
	          } else if (!(node instanceof org.htmlparser.html.tags.HTMLEndTag))
	            xmlTagFound = false;
	        }
	      }
	  ...
	  if (xmlTagFound) {
	      if (node!=null) {
	        if (node instanceof org.htmlparser.html.tags.HTMLEndTag) {
	          org.htmlparser.html.tags.HTMLEndTag endTag = (org.htmlparser.html.tags.HTMLEndTag)node;
