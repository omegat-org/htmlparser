...
import org.htmlparser.html.scanners.HTMLMetaTagScanner;
/**
 * @version 	1.0
 * @author
 */
public class HTMLMetaTagScannerTest extends TestCase {
	...
	public static void main(String[] args) {
		new junit.awtui.TestRunner().start(new String[] {"org.htmlparser.htmlTests.scannersTests.HTMLMetaTagScannerTest"});
	}
