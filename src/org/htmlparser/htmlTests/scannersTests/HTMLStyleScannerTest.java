...
import org.htmlparser.html.tags.HTMLStyleTag;
...
import org.htmlparser.html.scanners.HTMLStyleScanner;
...
public class HTMLStyleScannerTest extends junit.framework.TestCase 
{
	...
	public static void main(String[] args) {
		new junit.awtui.TestRunner().start(new String[] {"org.htmlparser.htmlTests.scannersTests.HTMLStyleScannerTest"});
	}
	/**
