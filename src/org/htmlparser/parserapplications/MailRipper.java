...
public class MailRipper
{
    ...
    public static void main (String[] args)
    {
        ...
        try
        {
            ...
            {
                LinkTag mail = (LinkTag)iterator.nextNode ();
                System.out.println (mail.getLink ());
            }
        }
        catch (ParserException e)
        {
     ...
     * @return A node list of mail addresses (LinkTag type).
     */
    public NodeList rip() throws ParserException
    {
        NodeList ret;
        
        ret = parser.extractAllNodesThatMatch (
            new AndFilter (
